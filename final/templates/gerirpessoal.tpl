...
">
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
            ...
            <h1 class="page-header">Gerir Pessoal {if $viewer.role === 'Administrador'}
                <button id="newUser" type="button" class="btn btn-default pull-right" data-toggle="modal" data-target="#addUserModal">
                        ...
                        <tr class="warning" id="user{$user.id|escape:'html'}">
                            ...
                            <tr id="user{$user.id|escape:'html'}">
                                ...
                                <td>
                                    ...
                                    {else}
                                    <i id="user{$user.id|escape:'html'}-frozen" class="fa fa-pause fa-lg fa-fw clickable" data-toggle="tooltip" data-original-title="Congelar"></i>
                                    {/if} {/if}
                                </td>
                            </tr>
                            {/foreach}
