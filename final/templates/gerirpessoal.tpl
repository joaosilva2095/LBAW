            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    {foreach $users as $key => $user}
                        ...
                        <td>{$user.role}</td>
                        <td>
                            <a href="user.php?user={$user.id}" class="fa fa-eye fa-lg fa-fw clickable"
                               data-toggle="tooltip" data-original-title="Ver"></a>
                            ...
                            {elseif $role === 'Contabilista' && $user.role === 'Amigo'}
                                {if $user.frozen}
                                    <i id="user{$user.id}-frozen" class="fa fa-play fa-lg fa-fw clickable"
                                       data-toggle="tooltip" data-original-title="Descongelar"></i>
                                {else}
                                    <i id="user{$user.id}-frozen" class="fa fa-pause fa-lg fa-fw clickable"
                                       data-toggle="tooltip" data-original-title="Congelar"></i>
                                {/if}
                            {/if}
                        </td>
                        </tr>
