    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            {if $viewer.role !== 'Amigo'}
                <a class="navbar-brand" href="homepage.php">G.A.S.Porto</a>
            {else}
                <a class="navbar-brand" href="amigo.php">G.A.S.Porto</a>
            {/if}
        </div>
                ...
                <li id="notifications" class="dropdown">
                    ...
                    <ul class="dropdown-menu list-group">
                        ...
                        {foreach $notifications as $notification}
                            <li id="notification{$notification.id|escape:'html'}"
                                class="list-group-item list-group-item-{$notification.notification_type|@strtolower}">{$notification.description}</li>
                        {/foreach}
                    </ul>
                </li>

                <li id="navsettings" class="dropdown">
                    <a href="" class="dropdown-toggle" onclick="return false"> <i class="fa fa-cog"
                                                                                  aria-hidden="true"></i> Opções </a>

                    <ul class="dropdown-menu list-group">
                        <li class="clickable" id="EditCredentials" data-toggle="modal"
                            data-target="#editCredentialsModal">
                            <a>
