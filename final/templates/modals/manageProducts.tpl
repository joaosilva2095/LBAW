            ...
            <div class="modal-body">
                <form id="newCatForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="catName" required="required">
                    </div>
                </form>
                <div class="alert alert-danger alert-dismissible" style="display: none;" role="alert" id="newCatStatus">
                    <button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span>
                    </button>
                    Erro a remover producto! Por favor verifique as informações
                </div>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="newCatModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 id="newCatModalTitle" class="modal-title">Remover Categoria</h4>
            </div>
            <div class="modal-body">
                <form id="newCatForm">
                    <div class="form-group">
