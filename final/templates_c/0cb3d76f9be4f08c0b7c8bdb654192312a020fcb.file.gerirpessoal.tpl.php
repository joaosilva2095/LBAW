...
<?php /*%%SmartyHeaderCode:21096728215730ae4904c941-21528714%%*/
...
<?php if ($_valid && !is_callable('content_5730ae49148db7_88625104')) {
    function content_5730ae49148db7_88625104($_smarty_tpl)
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            foreach ($_from as $_smarty_tpl->tpl_vars['user']->key => $_smarty_tpl->tpl_vars['user']->value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-pencil fa-lg fa-fw" data-toggle="tooltip"
                                           data-original-title="Editar"></i>
                                        <i class="fa fa-briefcase fa-lg fa-fw" data-toggle="tooltip"
                                           data-original-title="Alterar Cargo"></i>
                                        <i class="fa fa-trash fa-lg fa-fw" data-toggle="tooltip"
                    ...
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#registerUser"><i
                            class="fa fa-user-plus"></i> Novo Utilizador
                    </button>
                </div>
            </div>
        </div>
