...
<?php /*%%SmartyHeaderCode:863655255730ae49167662-21463009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
...
<?php if ($_valid && !is_callable('content_5730ae491a74b3_90426954')) {function content_5730ae491a74b3_90426954($_smarty_tpl) {?><nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#"><i class="fa fa-user"></i> <?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
 (<?php echo $_smarty_tpl->tpl_vars['user']->value['role'];?>
)</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i> Notificações <span class="badge"><?php echo count($_smarty_tpl->tpl_vars['notifications']->value);?>
</span></a>
